...
class c_Shell():
    ...
    def m_gradeHelper(self,name):
        instructions=[f"Assignments graded :{len(self.gradeMain.listOfStudentsGraded)}"
        ,f"Assignments left: {self.assignmentsToGrade - len(self.gradeMain.listOfStudentsGraded)}",
        "Select an option:"]
